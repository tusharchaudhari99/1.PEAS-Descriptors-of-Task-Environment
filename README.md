...
1. The agent detects that Room A is dirty and cleans it.
2. The agent moves from Room A to Room B.
3. The agent finds Room B clean and moves to Room C.
4. The agent detects that Room C is dirty and cleans it.
5. The agent checks the environment and determines that no dirty rooms remain.
6. The agent stops execution.
...
- `screenshots/` – Contains screenshots of program execution and output.
